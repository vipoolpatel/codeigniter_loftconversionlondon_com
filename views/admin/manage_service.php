...
<html lang="en">
    ...
    <body>
        ...
        <div class="row-fluid white-card mt20 extra-padding">
            <h4><?php echo $t != "" ? "EDIT" : "ADD";?> SERVICE</h4>
            <div class="addNewContents">
                <form method="post" name="frmEditContent" id="frmEditContent" action="<?php if ($t != "") echo site_url('admin/services/edit/' . $t->id); ?>">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        new AjaxUpload("#picture", {
            action: "<?php echo site_url('admin/services/upload_photo'); ?>",
            name: 'image',
