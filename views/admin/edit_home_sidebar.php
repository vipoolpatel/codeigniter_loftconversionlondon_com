        ...
        <div class="row-fluid white-card mt20 extra-padding">
            ...
            <div class=" ">
                <form method="post"  action="">
                        ...
                        <ul>
                            <li><h6>Title </h6>
                                <input class="form-control" name="title" value="<?=$home_sidebar->title?>" style="width: 100%;" required="" type="text" >
                                <input type="hidden" name="id" value="<?=$home_sidebar->id?>" >
                            </li>
                            
                            <li><h6> URL </h6>
                                <input class="form-control" name="url" style="width: 100%;" required type="text" value="<?=$home_sidebar->url?>">
                            </li>
                        </ul>
