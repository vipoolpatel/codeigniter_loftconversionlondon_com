                ...
                <form method="post"  action="">
                        ...
                        <ul>
                            <li><h6>Category Name </h6>
                                <input class="form-control" name="category_name" required="" type="text" style="width: 500px;">
                            </li>
                            
                            <li><h6>Category Page URL </h6>
                                <input class="form-control" name="category_slug" required type="text" style="width: 500px;">
                            </li>
                    ...
                    <div class="seo_packs">
                        ...
                        <ul>
                            ...
                            <li>
                                <h6>PAGE KEYWORDS</h6>
                                <textarea name="meta_keywords" id="meta_tags"></textarea>
                            </li>
                        </ul>
                    </div>
