                ...
                <!-- <form method="post" name="frmEditContent" id="frmEditContent" action=""> -->
                  <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div  class="addnewpagetitletxtbox margintop10">
                         <label>Title</label>
                        <input type="text" name="title" id="title" style="width: 70%;" value="<?=$getRecord->title?>">
                    </div>

                    <div class="seperator"></div>

                    <div class="paddingleft15">
                        <textarea name="description" id="txtPageDes"><?=$getRecord->description?></textarea>
                     ...
                     <div  class="addnewpagetitletxtbox margintop10">
                        ...
                        <br />
                           <?php
                            ...
                            <img style="height: 100px;" src="<?=base_url()?>upload/question/<?=$getRecord->image_name?>">
                    ...
                    <div class="seperator" style="margin-bottom: 15px;"></div>
                     <div  class="addnewpagetitletxtbox margintop10">
                        ...
                        <input type="checkbox" name="is_full_screen" <?= ($getRecord->is_full_screen == '1') ? 'checked' : '' ?>>
                    </div>
                     ...
                     <div  class="addnewpagetitletxtbox margintop10">
                        ...
                        <select name="order_by">
                            ...
                            {
                            ?>
                            <option <?=($getRecord->order_by == $i) ? 'selected' : ''?> value="<?=$i?>"><?=$i?></option>
                            <?php 
                            }
                            ?> 
