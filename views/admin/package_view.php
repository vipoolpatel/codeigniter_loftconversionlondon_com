...
<html lang="en">
    ...
    <body>
        ...
        <div class="row-fluid white-card mt20 extra-padding">
            ...
            <a href="<?php echo site_url('admin/package/add_package'); ?>" class="btn floatRight">ADD NEW PACKAGE</a><br><br>
            <div class="clear"></div>
            	...
            	<?php if($package){?>
	                <?php foreach ($package as $t) { ?>
	                    <tr>
	                        ...
	                        <td width="35%">
	                            <a href="<?php echo site_url('admin/package/edit_package/' . $t->id); ?>" class="edit_but btn btn-success">Edit</a>
	                            <a href="<?php echo site_url('admin/package/delete_package/' . $t->id); ?>" class="del btn btn-danger" onclick="return confirm('Are You sure to delete?');">Delete</a>
	                        </td>
	                    <tr>
                    <?php }?>
                <?php }else{?>
