...
class Loft_conversions extends CI_Controller{

	function __construct() {
        parent::__construct();
        $this->load->model('loft_conversions_model', 'service');
    }

    function index() {
        $data['services'] = $this->service->get_services();
        $this->load->view('admin/loft_conversions', $data);
    }
    ...
    function add() {
        if (isset($_POST['submit'])) {
            ...
            redirect('admin/loft_conversions');
        }
       
        $data['tot'] = 0;
        $this->load->view('admin/manage_loft_conversions', $data);
    }
