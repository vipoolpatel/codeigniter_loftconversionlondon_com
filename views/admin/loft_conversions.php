...
<html lang="en">
    ...
    <body>
        ...
        <div class="row-fluid white-card mt20 extra-padding">
            <h4 style="text-transform: uppercase;">MANAGE Loft Conversions Type</h4>

            <?php echo $this->session->flashdata('success') ? $this->session->flashdata('success') . "<br>" : ''; ?><br>
            <a href="<?php echo site_url('admin/loft_conversions/add'); ?>" class="btn floatRight">ADD NEW Loft Conversions Type</a><br><br>
            <div class="clear"></div>
                ...
                if($services->num_rows()>0){
	                foreach ($services->result() as $t) {
	                    ...
	                    <tr>
	                        ...
	                        <td width="35%">
	                            <a href="<?php echo site_url('admin/loft_conversions/edit/' . $t->id); ?>" class="edit_but btn btn-success">Edit</a>
	                            <a href="<?php echo site_url('admin/loft_conversions/delete/' . $t->id); ?>" class="del btn btn-danger" onclick="return confirm('Are you sure to delete?');">Delete</a>
	                        </td>
	            	...
	            	<tr><td colspan="2">No found!</td></tr>
             	<?php }?>
            </table>
